...
NeuroIntel is an integrated system of imaging analysis with a symptom diagnosis module to enhance the accuracy of disorder predictions. The system improved diagnostic precision, supporting early detection and intervention strategies. This webapp was developed using Flask Web Framework and was deployed on Heroku server. The models used to predict the neural diseases were trained on large Datasets. All the links for datasets and the python notebooks used for model creation are mentioned below in this readme. The webapp can predict following Diseases:

- Alzheimer's Disease
- Brain Tumor
- Brain stroke

We published a paper on this topic, as the first author, on the International Research Journal on Advanced Engineering Hub (IRJAEH) on December 2024. [Link to the publication](https://doi.org/10.47392/IRJAEH.2024.0381)
